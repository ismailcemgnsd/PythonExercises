...
if status == 0: # Compute tax for single filers
    ...
    if income <= 16700:
        ...
        tax = 16700 * 0.10 + (67900 - 16700) * 0.15 + (137050 - 67900) * 0.25 + (208850 - 137050) * 0.28 + (income - 137050) * 0.33
    else:
    ...
    if income <= 8350:
        ...
        tax = 8350 * 0.10 + (33950 - 8350) * 0.15 + (68525 - 33950) * 0.25 + (104425 - 68525) * 0.28 + (income - 104525) * 0.33
    else:
    ...
    if income <= 11950:
        ...
        tax = 11950 * 0.10 + (45500 - 11950) * 0.15 + (117450 - 45500) * 0.25 + (190200 - 117450) * 0.28 + (372950 - 190201) * 0.33 + (income - 372950) * 0.35
